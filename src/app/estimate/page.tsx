...
function EstimateContent() {
  ...
  const input: EligibilityInput = {
    ...
    waterHeaterReplace: (searchParams.get("waterHeaterReplace") as WaterHeaterReplace) || undefined,
    ...
    return (
      <div className="py-16 px-4 text-center">
        ...
        <p className="text-gray-600 mb-6">
          We couldn&apos;t find incentive data for your selection. Please try
          again.
        </p>
        <Link
          href="/eligibility"
  ...
  return (
    <div className="py-8 px-4 sm:px-6">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="text-gray-600 mb-6">
          Based on your answers, here&apos;s what you may qualify for under the NYS
          Clean Heat program.
        </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-semibold text-gray-900">
                  {estimate.utilityLabel}
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-500">Project Category</p>
                <p className="font-semibold text-gray-900">
                  {estimate.categoryLabel}
                </p>
            ...
            {estimate.isDac && estimate.dacBonus > 0 && (
              <div className="rounded-lg bg-green-50 border border-green-200 p-3">
                ...
                <p className="text-xs text-green-700 mt-1">
                  You&apos;re in a Disadvantaged Community, which qualifies you for
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <p className="text-sm text-gray-500 mb-3">
              Your contractor will need these documents to submit your
              application:
            </p>
        ...
        <Alert className="bg-amber-50 border-amber-200">
          <AlertDescription className="text-amber-800 text-sm">
            <strong>Disclaimer:</strong> Incentive amounts shown are estimates
            based on current program data. Final eligibility and amounts depend
            on current program rules, equipment specifications, and utility
            requirements. Incentive rates are subject to change. Always confirm
            with your contractor and NYSERDA before making purchasing decisions.
          </AlertDescription>
        </Alert>
      </div>
    </div>
