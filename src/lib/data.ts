...
export const SAMPLE_PROJECTS: Project[] = [
  {
    ...
    category: "cat_2a",
    categoryLabel: "Air Source Heat Pump (Ducted) — Retrofit, Full Displacement",
    homeType: "single_family",
    isNewConstruction: false,
    isDac: false,
    estimatedIncentive: 4600,
    status: "draft",
  ...
  },
  {
    ...
    category: "cat_3",
    categoryLabel: "Air Source Heat Pump (Ductless/Mini-Split)",
    homeType: "condo",
    isNewConstruction: false,
    isDac: true,
    estimatedIncentive: 2250,
    status: "in_progress",
  ...
  },
  {
    ...
    category: "cat_4",
    categoryLabel: "Ground Source Heat Pump",
    homeType: "single_family",
    isNewConstruction: false,
    isDac: false,
  ...
  },
  {
    ...
    utilityLabel: "NYSEG",
    category: "cat_5b",
    categoryLabel: "Heat Pump Water Heater — Replacing Fossil Fuel",
    homeType: "single_family",
    isNewConstruction: false,
    isDac: true,
