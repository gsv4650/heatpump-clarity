...
export const SAMPLE_PROJECTS: Project[] = [
  {
    ...
    category: "cat_2a",
    categoryLabel: "ccASHP Full Load with Integrated Controls",
...
export const SAMPLE_MANUAL_UPDATES: ManualUpdate[] = [
  {
    id: "upd-001",
    title: "See your potential rebate in seconds",
    description:
      "Real incentives based on your home and utility program.",
    published: true,
  ...
  {
    id: "upd-002",
    title: "NYS Clean Heat incentive rates updated for 2026",
    description:
      "Program incentives have been updated across all participating utility territories. Check your eligibility to see current rebate amounts for your home and project type.",
    published: false,
  ...
  {
    id: "upd-003",
    title: "New documentation requirements for ASHP projects",
    description:
      "Starting February 1, 2026, all ccASHP Full Load projects must include a completed Manual J load calculation with the application.",
    published: false,
